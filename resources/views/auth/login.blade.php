                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kontak" type="text" class="form-control @error('kontak') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="kontak" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="offset-md-4 col-md-6">
                                <div class="hasil_refreshcaptcha">
                                {!! captcha_img('flat') !!}
                                </div>
...
@section('scripts')
    <script>
        ...
        success: function(json) {
            $('.hasil_refreshcaptcha').html(json);
        },
    error: function(data) {
        alert('Try Again.');
    }
