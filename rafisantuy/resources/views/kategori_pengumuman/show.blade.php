        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="from-group row">
                    ...
                    <label class="col-md-8 col-from-label text-md-left">{!! $kategoriPengumuman->created_at->format('d/m/YH:i') !!}</label>
                </div>

                <div class="from-group row">
                    <label class="col-md-4 col-from-label text-md-right">Update</label>
                    <label class="col-md-8 col-from-label text-md-left">{!! $kategoriPengumuman->updated_at->format('d/m/YH:i') !!}</label>
                </div>

                <div class="from-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                        <a href="{!! route('kategori_pengumuman.index') !!}" class="btn btn-danger">back</a>
                    </div>
                </div>
